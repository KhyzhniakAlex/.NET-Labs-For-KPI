<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManufacturersPage.aspx.cs" Inherits="WebFormsClient.ManufacturersPage" MasterPageFile="~/Site.Master"%>
        ...
        <asp:Repeater ID="Repeater" runat="server" onitemcommand="Repeater1_ItemCommand">
            <ItemTemplate>
                <div>
                    ...
                    <h6>OfficePhoneNumber:  <%#Eval("OfficePhoneNumber") %></h6>
                    <h6>Country:  <%#Eval("Country") %></h6>
                </div>
