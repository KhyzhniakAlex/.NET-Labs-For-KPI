<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarPage.aspx.cs" Inherits="WebFormsMsMqClient.CarPage" MasterPageFile="~/Site.Master"%>
        ...
        <asp:Repeater ID="Repeater" runat="server" onitemcommand="Repeater1_ItemCommand">
            <ItemTemplate>
                <div>
                    ...
                    <h6>Manufacturer:  <%#Eval("ManufacturerId") %></h6>
                </div>
